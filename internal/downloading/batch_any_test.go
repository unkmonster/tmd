...
func TestBatchDownloadAny_Empty(t *testing.T) {
	...
	result, _, _, err := BatchDownloadAny(ctx, nil, db, []twitter.ListBase{}, []*twitter.User{}, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
...
func TestBatchDownloadAny_NilInputs(t *testing.T) {
	...
	result, _, _, err := BatchDownloadAny(ctx, nil, db, nil, nil, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
...
func TestBatchDownloadAny_WithUsersOnly(t *testing.T) {
	...
	_, _, _, _ = BatchDownloadAny(ctx, nil, db, []twitter.ListBase{}, users, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
}
...
func TestBatchDownloadAny_WithListsOnly(t *testing.T) {
	...
	_, _, _, _ = BatchDownloadAny(ctx, nil, db, []twitter.ListBase{mockList}, []*twitter.User{}, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
}
...
func TestBatchDownloadAny_WithBoth(t *testing.T) {
	...
	_, _, _, _ = BatchDownloadAny(ctx, nil, db, []twitter.ListBase{mockList}, users, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
}
...
func TestBatchDownloadAny_ListError(t *testing.T) {
	...
	_, _, _, err := BatchDownloadAny(ctx, nil, db, []twitter.ListBase{mockList}, []*twitter.User{}, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
	if err == nil {
...
func TestBatchDownloadAny_MultipleLists(t *testing.T) {
	...
	_, _, _, _ = BatchDownloadAny(ctx, nil, db, lists, []*twitter.User{}, tempDir, tempDir, false, nil, nil, nil, RuntimeOptions{}, nil)
}
...
func TestBatchDownloadAny_DifferentDirs(t *testing.T) {
	...
	_, _, _, _ = BatchDownloadAny(ctx, nil, db, []twitter.ListBase{mockList}, []*twitter.User{}, dir1, dir2, false, nil, nil, nil, RuntimeOptions{}, nil)
}
...
func TestBatchDownloadAny_AutoFollow(t *testing.T) {
	...
	_, _, _, _ = BatchDownloadAny(ctx, nil, db, []twitter.ListBase{mockList}, []*twitter.User{}, tempDir, tempDir, true, nil, nil, nil, RuntimeOptions{}, nil)
}
