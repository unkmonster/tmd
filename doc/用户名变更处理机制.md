...
**位置**: [`internal/downloading/features.go:441-474`](../internal/downloading/features.go#L441-L474)
...
**位置**: [`internal/downloading/entity.go:24-39`](../internal/downloading/entity.go#L24-L39)

```go
func syncPath(path SmartPath, expectedName string) error {
    if !path.Recorded() {
        return path.Create(expectedName)  // 新用户：创建文件夹
    }

    if path.Name() != expectedName {
        return path.Rename(expectedName)  // 用户名变更：重命名文件夹
    }
...
**位置**: [`internal/downloading/entity.go:89-107`](../internal/downloading/entity.go#L89-L107)
...
**位置**: [`internal/profile/downloader.go:238-325`](../internal/profile/downloader.go#L238-L325)
...
**位置**: [`internal/downloading/entity.go:266-302`](../internal/downloading/entity.go#L266-L302)
...
- [`internal/database/db_test.go`](../internal/database/db_test.go) - `TestUserOperation`, `TestUserEntity`, `TestLink`
